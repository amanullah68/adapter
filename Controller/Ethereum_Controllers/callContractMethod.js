  ...
  try {
    ...
    await web3.eth.getTransactionReceipt(account_address, async function (err, receipt) {
      ...
      try {
        ...
        // console.log('rawTx111', rawTx);
        await sendRaw(rawTx, async function (Result) {
          //  console.log("Transaction performed: " + Result); // 0x5417430a1036911b908de6d92a012bb30cd59b5170c002397639bd8106f95a82
          var a = [];
          a.push(Result);
          var b = a.toString();
          str = b.substring(7);
          // //console.log('bbbbbbbbbbbbbbbbbb............', a.toString());
          if (b.includes('Error:')) {
